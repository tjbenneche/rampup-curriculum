...
JavaScript is an interpreted language designed primarily for client-side use on the web. It was created in the mid-90s to enrich the web with user interaction and animation, but took a number of years to become a supported standard in major web browsers.
