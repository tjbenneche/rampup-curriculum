...
2. $(this) - how it differs from JavaScript's native "this", when to use it
3. preventDefault() - when would we use this, what is its purpose?
4. Chaining functions
5. DOM traversal - parents, children, siblings, adding and removing data
6. Discuss homework!
